...
- `src/app/core`: infraestrutura da aplicacao, como API services, auth, guards, interceptors e tenant.
- `src/app/features`: telas e fluxos de negocio agrupados por dominio.
...
- Funcoes reutilizaveis de formatacao, data e erro devem ficar em `src/app/shared/utils`.
